...
|------------|-----|-----------|
| Device Tree | https://github.com/lycodump/android_device_xiaomi_sapphire.git | `source/device_xiaomi_sapphire/` |
| Vendor Tree | https://github.com/lycodump/android_vendor_xiaomi_sapphire.git | `source/vendor_xiaomi_sapphire/` |
| Kernel Source | https://github.com/lycodump/android_device_xiaomi_sapphire-kernel.git | `source/kernel_xiaomi_sapphire/` |
